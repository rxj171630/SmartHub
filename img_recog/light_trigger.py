...
#class Light_On(Resource):    
#    @cross_origin(origin='*',headers=['Content-Type','Authorization'])    
#    def get(self):        
#        r=requests.get(            
#            "https://maker.ifttt.com/trigger/light_on/with/key/dYp8LQdZcmQ_rlSx-Gfhpn",        
#        )
...
#                Light_ON.get(self)
            ...
            if(labels[label_id] == '0'):
                r=requests.get(            
            "https://maker.ifttt.com/trigger/light_off/with/key/dYp8LQdZcmQ_rlSx-Gfhpn",        
        )
